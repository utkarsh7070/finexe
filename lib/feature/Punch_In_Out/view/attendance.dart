...
class _AttendanceScreenState extends ConsumerState<AttendanceScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    bool?
    allowed;
    if(checkPunchProvider.punchAllowed!=null){

      allowed=checkPunchProvider.punchAllowed;
    ...
    return allowed!=null? Scaffold(
      appBar: AppBar(actions: [
         IconButton(
          onPressed: () {
           // showCustomSnackBar(context,checkPunchProvider.punchAllowed.toString() ,Colors.red,);
                        ...
                        if (selectedOption == "Leave") ...[
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              decoration:
                              customInputDecoration("Enter your remark"),
                              maxLines: 3,
                              validator: (value) =>
                          ...
                          ElevatedButton(
                            onPressed: () async {
                              ...
                              if (reasonForPunch.isNotEmpty) {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
                                      content: Text("Please fill Remark")),
                                );
                              }
                            },
                            style: ElevatedButton.styleFrom(
