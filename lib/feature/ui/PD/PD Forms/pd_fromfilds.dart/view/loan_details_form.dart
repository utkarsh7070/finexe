...
class LoanDetailsForm extends ConsumerWidget {
  final String customerId;

  const LoanDetailsForm({required this.customerId,super.key});
  ...
  Widget build(BuildContext context,WidgetRef ref) {
    ...
    final getLoandata = ref.watch(loanDetailsGetProvider(customerId));
