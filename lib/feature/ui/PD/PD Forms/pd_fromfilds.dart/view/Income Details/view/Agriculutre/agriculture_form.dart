...
// // }
//
// class AgricultureIncomeDetail extends ConsumerWidget {
//   final String customerId;
//
//   const AgricultureIncomeDetail({required this.customerId, super.key});
//
...
//     final agriBusinessAsyncValue = ref.watch(agriBusinessProvider(customerId));
//     final otherDataAsyncValue = ref.watch(otherProvider(customerId));
//     final selectedValues = ref.watch(multiSelectProvider);
//     final selectedValuesViewModel = ref.read(multiSelectProvider.notifier);
//     final isExpandedState = ref.read(isExpanded.notifier);
//     final isExpandedVal = ref.watch(isExpanded);
//     final isSelected = selectedValuesViewModel.state.contains(selectedValuesViewModel.options);
//
...
//                       onTap: () =>
//                           isExpandedState.state = !isExpandedState.state,
//                       child: Container(
...
//                           color:
//                               Colors.white.withOpacity(0.7), // Semi-transparent
//                         ),
//                         child: Column(
//                           crossAxisAlignment: CrossAxisAlignment.start,
//                           children: [
...
//                                     agriData.agriculturePhotos!.removeAt(index);
//                                     print(
...
//                             // ],
//                             agriculturePhotos: agriData?.agriculturePhotos,
...
//                                 incomeForm_FertilizerOwnerContact.text,
//                             irrigationMethod: incomeForm_TypeofIrrigation.text,
