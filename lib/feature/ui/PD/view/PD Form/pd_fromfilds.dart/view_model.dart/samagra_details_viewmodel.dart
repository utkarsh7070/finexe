...
final samagraDetailDetailsProvider =
    FutureProvider.autoDispose<SamagraDetailsItems>((ref) async {
  final viewModel = SamagraFormDetailsProvider();
  return await viewModel.fetchSamagraFormDetails();
});

class SamagraFormDetailsProvider {
  final Dio _dio = Dio();

  Future<SamagraDetailsItems> fetchSamagraFormDetails() async {
    String? token =
