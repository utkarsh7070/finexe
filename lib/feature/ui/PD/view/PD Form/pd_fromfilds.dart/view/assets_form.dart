...
//       TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    final getAssetData = ref.watch(getAssetDetailFromProvider);

    return getAssetData.when(
      data: (geetingAssetData) {
        print(
            'object: ${geetingAssetData.items!.assetDetails![0].marketValue}');
        print(
            'object: ${geetingAssetData.items!.assetDetails![0].purchaseValue}');
        print(
            'object: ${geetingAssetData.items!.total!.totalMarketValue!.toDouble()}');
        if (!isInitialDataSet) {
          totalMarketValue =
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      alignment: Alignment.centerLeft,
                      child: Text(
                        'Total Purchase: $totalMarketValue /-',
                    ...
                    Container(
                      alignment: Alignment.centerLeft,
                      child: Text(
                        'Total Market: $totalPurchaseValue /-',
                        textAlign: TextAlign.left,
                        style: AppStyles.blacktext14,
                      ),
                    ),
