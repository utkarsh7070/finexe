...
class _SamagraDetailsFormState extends ConsumerState<SamagraDetailsForm> {
  ...
  Widget build(BuildContext context) {
    ...
    final getSamagraFormDetails = ref.watch(samagraDetailDetailsProvider);

    // final isUploading = ref.watch(uploadImageProvider).isLoading;

    return getSamagraFormDetails.when(
      data: (samagradata) {
                                  ...
                                  (value) {
                                    if (value != null) {
                                      ...
                                      ref
                                        ...
                                        (value) {
                                          setState(() {
                                            sssmIDimageUrl = value;
                                            // imgeUrl.add(value);

                                            print(
                                                'sssmIDimageUrl:: $sssmIDimageUrl');
                                            // print(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: sssmidimage.image != null ||
                                            sssmidimage.image?.path != null
                                        ? Image.file(
                                            File(sssmidimage.image!.path),
                                            height:
                          ...
                          : Stack(
                              children: [
                                Padding(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(12),
                                    child: gasPhtotoImage?.path != null
                                        ? Image.file(
                              ...
                              onPressed: () async {
                                ...
                                await ref
                                    ...
                                    .submitSamagraDetails(
                                        ...
                                        //   imagePaths: imgeUrl,
                                        gasdiaryPhoto: gasDiaryImageUrl,
                                        sssmPhoto: sssmIDimageUrl,
                                        context: context);
                              },
