...
//change return type
final paginatedRejectDataProvider = FutureProvider.autoDispose.family<List<RejectItem>, int>((ref,page) async {
...
class ApiService {
  ...
  Future<List<RejectItem>> fetchData({
    ...
    try {
      ...
      PdRejectResponseModel responseModel = PdRejectResponseModel.fromJson(response.data);
      print(response.data);
