...
part 'get_applicant_form_response_model.g.dart';

@JsonSerializable()
class GetApplicantFormResponseModel {
  @JsonKey(name: "status")
  bool status;
  ...
  factory GetApplicantFormResponseModel.fromJson(Map<String, dynamic> json) => _$GetApplicantFormResponseModelFromJson(json);

  Map<String, dynamic> toJson() => _$GetApplicantFormResponseModelToJson(this);
}

@JsonSerializable()
class GetApplicantItems {
  @JsonKey(name: "_id")
  String id;
  ...
  @JsonKey(name: "__v")
  int v;
  @JsonKey(name: "applicantCibilReport")
  String applicantCibilReport;
  ...
  factory GetApplicantItems.fromJson(Map<String, dynamic> json) => _$GetApplicantItemsFromJson(json);

  Map<String, dynamic> toJson() => _$GetApplicantItemsToJson(this);
}
