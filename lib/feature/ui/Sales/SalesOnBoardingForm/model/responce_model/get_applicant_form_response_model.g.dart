...
part of 'get_applicant_form_response_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

GetApplicantFormResponseModel _$GetApplicantFormResponseModelFromJson(
        Map<String, dynamic> json) =>
    GetApplicantFormResponseModel(
      status: json['status'] as bool,
      subCode: (json['subCode'] as num).toInt(),
      message: json['message'] as String,
      error: json['error'] as String,
      items: GetApplicantItems.fromJson(json['items'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$GetApplicantFormResponseModelToJson(
        GetApplicantFormResponseModel instance) =>
    <String, dynamic>{
...
GetApplicantItems _$GetApplicantItemsFromJson(Map<String, dynamic> json) =>
    GetApplicantItems(
      ...
      applicantCibilReport: json['applicantCibilReport'] as String,
    );

Map<String, dynamic> _$GetApplicantItemsToJson(GetApplicantItems instance) =>
    <String, dynamic>{
      '_id': instance.id,
      ...
      '__v': instance.v,
      'applicantCibilReport': instance.applicantCibilReport,
    };
