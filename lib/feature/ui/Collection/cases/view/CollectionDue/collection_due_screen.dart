...
import '../../view_model/collection_due_view_model.dart';
...
class CollectionDue extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final dropDownControllers = ref.watch(collectionDueDropDownControllerProvider);
    final dropDownData = ref.read(collectionDueDropDown);

    final paymentState = ref.watch(paymentCollectionDueViewModelProvider);
    final paymentViewModel = ref.read(paymentCollectionDueViewModelProvider.notifier);
    final paymentFocusStates =
    ref.watch(paymentCollectionDueFocusProvider);
    final paymentFocusViewModel =
    ref.read(paymentCollectionDueFocusProvider.notifier);
    return Scaffold(
      appBar: AppBar(
